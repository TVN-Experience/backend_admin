...
<?php
	...
	$sql = "SELECT * FROM `" . TABLE_PREFIX . "boot_notifications` ORDER BY `id` DESC LIMIT 1;";
...
<?php
	...
	function saveStartupMessage() {
		...
		if(isset($_POST["submit"]) && isset($_POST["startupMessage"])) {
			...
			$startupMessageId = $backendDB->query("INSERT INTO `" . TABLE_PREFIX . "boot_notifications` (`id`, `message`) VALUES (NULL, '$postedStartupMessage');", true);
